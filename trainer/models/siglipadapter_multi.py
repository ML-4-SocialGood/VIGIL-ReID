...
class SIGLIPAdapter_multi(Trainer):
    ...
    def build_model(self):
        ...
        self.model = CustomSIGLIP(
            self.cfg, self.data_manager.num_classes, siglip_model, self.data_manager.get_source_domains
        )
        ...
        for domain_id, domain_name in enumerate(self.data_manager.get_source_domains):
