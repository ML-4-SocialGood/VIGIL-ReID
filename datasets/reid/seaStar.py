...
class SeaStar(DatasetBase):
    """
        SeaStar
        Reference: O. Wahltinez and S. J. Wahltinez, 'An open-source general purpose machine learning framework for individual animal re-identification using few-shot learning', 
                    Methods in Ecology and Evolution, vol. 15, no. 2, pp. 373-387, 2024, doi: 10.1111/2041-210X.14278.
